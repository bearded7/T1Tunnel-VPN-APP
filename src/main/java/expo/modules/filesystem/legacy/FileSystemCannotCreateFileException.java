...
/* JADX INFO: compiled from: FileSystemExceptions.kt */
...
public final class FileSystemCannotCreateFileException extends CodedException {
    public FileSystemCannotCreateFileException(Uri uri) {
        String string;
        super((uri == null || (string = new StringBuilder("Provided uri '").append(uri).append("' is not pointing to a directory").toString()) == null) ? "Unknown error" : string, null, 2, null);
    }
}

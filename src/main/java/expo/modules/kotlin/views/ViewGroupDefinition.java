...
/* JADX INFO: compiled from: ViewGroupDefinition.kt */
...
public final class ViewGroupDefinition {
    ...
    public ViewGroupDefinition(Function3<? super ViewGroup, ? super View, ? super Integer, Unit> function3, Function2<? super ViewGroup, ? super Integer, ? extends View> function2, Function1<? super ViewGroup, Integer> function1, Function2<? super ViewGroup, ? super View, Unit> function4, Function2<? super ViewGroup, ? super Integer, Unit> function5) {
        this.addViewAction = function3;
        this.getChildAtAction = function2;
        this.getChildCountAction = function1;
        this.removeViewAction = function4;
        this.removeViewAtAction = function5;
    }

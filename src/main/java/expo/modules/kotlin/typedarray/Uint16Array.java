...
/* JADX INFO: compiled from: ConcreteTypedArrays.kt */
...
public final class Uint16Array implements TypedArray, GenericTypedArray<UShort>, RawTypedArrayHolder {
    ...
    public /* bridge */ /* synthetic */ UShort get(int i) {
        return UShort.m1049boximpl(m747getBwKQO78(i));
    }
    ...
    public /* bridge */ /* synthetic */ void set(int i, UShort uShort) {
        m748seti8woANY(i, uShort.getData());
    }

    /* JADX INFO: renamed from: get-BwKQO78, reason: not valid java name */
    public short m747getBwKQO78(int index) {
        Uint16Array uint16Array = this;
        if (index >= 0 && index < uint16Array.getLength()) {
            return UShort.m1055constructorimpl(read2Byte(index * 2));
        }
        throw new IndexOutOfBoundsException();
    }

    /* JADX INFO: renamed from: set-i8woANY, reason: not valid java name */
    public void m748seti8woANY(int index, short value) {
        Uint16Array uint16Array = this;
        if (index >= 0 && index < uint16Array.getLength()) {

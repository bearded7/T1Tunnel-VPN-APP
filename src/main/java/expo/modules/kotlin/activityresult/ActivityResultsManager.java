...
/* JADX INFO: compiled from: ActivityResultsManager.kt */
                ...
                final ?? r5 = new OnActivityAvailableListener() { // from class: expo.modules.kotlin.activityresult.ActivityResultsManager$1$invokeSuspend$$inlined$withActivityAvailable$1
                    ...
                    public void onActivityAvailable(AppCompatActivity activity) {
                        ...
                        if (cancellableContinuationImpl2.isActive()) {
                            ...
                            cancellableContinuation.resumeWith(objM772constructorimpl);
                        }
                    }
                };
            ...
            public void onActivityAvailable(AppCompatActivity activity) {
                ...
                if (cancellableContinuationImpl2.isActive()) {
                    ...
                    try {
                        ...
                        objM772constructorimpl = Result.m772constructorimpl(this.registry.register("AppContext_rq#" + this.nextLocalRequestCode.getAndIncrement(), activity, appContextActivityResultContract, appContextActivityResultFallbackCallback));
                    } catch (Throwable th) {
                        Result.Companion companion2 = Result.INSTANCE;
                        objM772constructorimpl = Result.m772constructorimpl(ResultKt.createFailure(th));
                    }

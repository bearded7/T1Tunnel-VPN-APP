...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m942boximpl(ULong.m948constructorimpl(getMostSignificantBits())), ULong.m942boximpl(ULong.m948constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m2273toUByteArrayTcUX1vc() {
        return UByteArray.m845constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        return j != other.mostSignificantBits ? Long.compare(ULong.m948constructorimpl(j) ^ Long.MIN_VALUE, ULong.m948constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE) : Long.compare(ULong.m948constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m948constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m2275fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m2274fromUByteArrayGBYM_sE(byte[] ubyteArray) {

...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m863boximpl(m2008nextpVg5ArA());
    }
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        this.hasNext = z;
        this.step = UInt.m869constructorimpl(i3);
    ...
    public int m2008nextpVg5ArA() {
        ...
        this.next = UInt.m869constructorimpl(this.step + i);
        return i;
    }
}

...
public final class LongSaturatedMathKt {
    ...
    public static final long m2239saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long jM2173toLongimpl = Duration.m2173toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m2238checkInfiniteSumDefinedPjuGub4(j, j2, jM2173toLongimpl);
        }
        if (((jM2173toLongimpl - 1) | 1) == Long.MAX_VALUE) {
            return m2240saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
        long j3 = j + jM2173toLongimpl;
        if (((j ^ j3) & (jM2173toLongimpl ^ j3)) < 0) {
    ...
    private static final long m2238checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m2159isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m2240saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long jM2137divUwyO8pc = Duration.m2137divUwyO8pc(j2, 2);
        long jM2173toLongimpl = Duration.m2173toLongimpl(jM2137divUwyO8pc, durationUnit);
        return (1 | (jM2173toLongimpl - 1)) == Long.MAX_VALUE ? jM2173toLongimpl : m2239saturatingAddNuflL3o(m2239saturatingAddNuflL3o(j, durationUnit, jM2137divUwyO8pc), durationUnit, Duration.m2162minusLRDsOJo(j2, jM2137divUwyO8pc));
    }

    private static final long infinityOfSign(long j) {
        return j < 0 ? Duration.INSTANCE.m2224getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.INSTANCE.m2223getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m2178unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            if (durationUnit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                return Duration.m2163plusLRDsOJo(DurationKt.toDuration(j4, DurationUnit.MILLISECONDS), DurationKt.toDuration(j5, durationUnit));
            }
            return Duration.m2178unaryMinusUwyO8pc(infinityOfSign(j3));
        }

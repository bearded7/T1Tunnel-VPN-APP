...
public final class Instant implements Comparable<Instant>, Serializable {
    ...
    public final Instant m2232minusLRDsOJo(long duration) {
        return m2234plusLRDsOJo(Duration.m2178unaryMinusUwyO8pc(duration));
    }

    /* JADX INFO: renamed from: minus-UwyO8pc, reason: not valid java name */
    public final long m2233minusUwyO8pc(Instant other) {
        Intrinsics.checkNotNullParameter(other, "other");
        Duration.Companion companion = Duration.INSTANCE;
        long duration = DurationKt.toDuration(this.epochSeconds - other.epochSeconds, DurationUnit.SECONDS);
        Duration.Companion companion2 = Duration.INSTANCE;
        return Duration.m2163plusLRDsOJo(duration, DurationKt.toDuration(this.nanosecondsOfSecond - other.nanosecondsOfSecond, DurationUnit.NANOSECONDS));
    }
    ...
    public final Instant m2234plusLRDsOJo(long duration) {
        long jM2148getInWholeSecondsimpl = Duration.m2148getInWholeSecondsimpl(duration);
        int iM2150getNanosecondsComponentimpl = Duration.m2150getNanosecondsComponentimpl(duration);
        if (jM2148getInWholeSecondsimpl == 0 && iM2150getNanosecondsComponentimpl == 0) {
            return this;
        }
        long j = this.epochSeconds;
        long j2 = j + jM2148getInWholeSecondsimpl;
        if ((j ^ j2) >= 0 || (jM2148getInWholeSecondsimpl ^ j) < 0) {
            return INSTANCE.fromEpochSeconds(j2, this.nanosecondsOfSecond + iM2150getNanosecondsComponentimpl);
        }
        return Duration.m2161isPositiveimpl(duration) ? MAX : MIN;
    }
}

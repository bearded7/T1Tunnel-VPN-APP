...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m2250boximpl(m2244markNowz9LOYto());
    }
    ...
    public long m2244markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m2253constructorimpl(read());
    }

    /* JADX INFO: renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m2243elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m2242differenceBetweenfRLX17w(long one, long another) {
    ...
    public final long m2241adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m2253constructorimpl(LongSaturatedMathKt.m2239saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}

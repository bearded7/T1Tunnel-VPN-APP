...
public final class UMathKt {
    ...
    private static final int m1994minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1973minOfJ1ME1BU(i, i2);
    }

    /* JADX INFO: renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m1995mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m1981minOfeb3DHEI(j, j2);
    }

    /* JADX INFO: renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m1992maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1961maxOfJ1ME1BU(i, i2);
    }

    /* JADX INFO: renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m1993maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m1969maxOfeb3DHEI(j, j2);
    }
}

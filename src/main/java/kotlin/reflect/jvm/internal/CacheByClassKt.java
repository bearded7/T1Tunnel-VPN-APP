...
public final class CacheByClassKt {
    ...
    static {
        ...
        try {
            ...
            objM772constructorimpl = Result.m772constructorimpl(Class.forName("java.lang.ClassValue"));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM772constructorimpl = Result.m772constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m779isSuccessimpl(objM772constructorimpl)) {
            Result.Companion companion3 = Result.INSTANCE;
            objM772constructorimpl = true;
        }
        Object objM772constructorimpl2 = Result.m772constructorimpl(objM772constructorimpl);
        if (Result.m778isFailureimpl(objM772constructorimpl2)) {
            objM772constructorimpl2 = false;
        }
        useClassValue = ((Boolean) objM772constructorimpl2).booleanValue();
    }

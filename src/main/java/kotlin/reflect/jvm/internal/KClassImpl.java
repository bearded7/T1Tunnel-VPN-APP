...
public final class KClassImpl<T> extends KDeclarationContainerImpl implements KClass<T>, KClassifierImpl, KTypeParameterOwnerImpl {
    ...
    public final class Data extends KDeclarationContainerImpl.Data {
        ...
        public static final List supertypes_delegate$lambda$18(final Data data, final KClassImpl kClassImpl) {
            Collection<KotlinType> collectionMo2062getSupertypes = data.getDescriptor().getTypeConstructor().mo2062getSupertypes();
            Intrinsics.checkNotNullExpressionValue(collectionMo2062getSupertypes, "getSupertypes(...)");
            ArrayList arrayList = new ArrayList(collectionMo2062getSupertypes.size());
            for (final KotlinType kotlinType : collectionMo2062getSupertypes) {
        ...
        public static final Type supertypes_delegate$lambda$18$lambda$15$lambda$14(KotlinType kotlinType, Data data, KClassImpl kClassImpl) {
            ...
            if (!(classifierDescriptorMo2061getDeclarationDescriptor instanceof ClassDescriptor)) {
                throw new KotlinReflectionInternalError("Supertype not a class: " + classifierDescriptorMo2061getDeclarationDescriptor);
            }
            Class<?> javaClass = UtilKt.toJavaClass((ClassDescriptor) classifierDescriptorMo2061getDeclarationDescriptor);
            if (javaClass == null) {
                throw new KotlinReflectionInternalError("Unsupported superclass of " + data + ": " + classifierDescriptorMo2061getDeclarationDescriptor);
            }
            ...
            if (iIndexOf < 0) {
                throw new KotlinReflectionInternalError("No superclass of " + data + " in Java reflection for " + classifierDescriptorMo2061getDeclarationDescriptor);
            }

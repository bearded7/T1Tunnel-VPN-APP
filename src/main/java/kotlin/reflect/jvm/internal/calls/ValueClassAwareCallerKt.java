...
public final class ValueClassAwareCallerKt {
    ...
    private static final List<String> getMfvcUnboxMethods$getUnboxMethodNameSuffixes(SimpleType simpleType) {
        ...
        ClassifierDescriptor classifierDescriptorMo2061getDeclarationDescriptor = simpleType.getConstructor().mo2061getDeclarationDescriptor();
        ...
        MultiFieldValueClassRepresentation<SimpleType> multiFieldValueClassRepresentation = DescriptorUtilsKt.getMultiFieldValueClassRepresentation((ClassDescriptor) classifierDescriptorMo2061getDeclarationDescriptor);
    ...
    public static final List<Method> getMfvcUnboxMethods(SimpleType type) {
        ...
        ClassifierDescriptor classifierDescriptorMo2061getDeclarationDescriptor = type.getConstructor().mo2061getDeclarationDescriptor();
        Intrinsics.checkNotNull(classifierDescriptorMo2061getDeclarationDescriptor, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ClassDescriptor");
        Class<?> javaClass = UtilKt.toJavaClass((ClassDescriptor) classifierDescriptorMo2061getDeclarationDescriptor);
    ...
    /* JADX WARN: Code duplicated, block: B:39:? A[LOOP:0: B:21:0x0069->B:39:?, LOOP_END, SYNTHETIC] */
    ...
    public static final Class<?> toInlineClass(KotlinType kotlinType) {
        ...
        Class<?> inlineClass = toInlineClass(kotlinType.getConstructor().mo2061getDeclarationDescriptor());
        if (inlineClass == null) {
            return null;
        }

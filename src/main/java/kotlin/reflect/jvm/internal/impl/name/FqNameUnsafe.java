...
/* JADX INFO: compiled from: FqNameUnsafe.kt */
...
public final class FqNameUnsafe {
    ...
    public final FqNameUnsafe child(Name name) {
        ...
        if (isRoot()) {
            ...
            strAsString = this.fqName + FilenameUtils.EXTENSION_SEPARATOR + name.asString();
        }
    ...
    public final boolean startsWith(Name segment) {
        ...
        int iIndexOf$default = StringsKt.indexOf$default((CharSequence) this.fqName, FilenameUtils.EXTENSION_SEPARATOR, 0, false, 6, (Object) null);

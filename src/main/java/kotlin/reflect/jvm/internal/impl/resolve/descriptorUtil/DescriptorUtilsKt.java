...
public final class DescriptorUtilsKt {
    ...
    public static final ClassDescriptor resolveTopLevelClass(ModuleDescriptor moduleDescriptor, FqName topLevelClassFqName, LookupLocation location) {
        ...
        ClassifierDescriptor contributedClassifier = moduleDescriptor.getPackage(topLevelClassFqName.parent()).getMemberScope().mo2063getContributedClassifier(topLevelClassFqName.shortName(), location);
    ...
    public static final ClassDescriptor getSuperClassNotAny(ClassDescriptor classDescriptor) {
        ...
        for (KotlinType kotlinType : classDescriptor.getDefaultType().getConstructor().mo2062getSupertypes()) {
            if (!KotlinBuiltIns.isAnyOrNullableAny(kotlinType)) {
                ...
                if (DescriptorUtils.isClassOrEnumClass(classifierDescriptorMo2061getDeclarationDescriptor)) {
                    ...
                    return (ClassDescriptor) classifierDescriptorMo2061getDeclarationDescriptor;
                }
            }
        }
        return null;
    ...
    /* JADX INFO: compiled from: DescriptorUtils.kt */
    /* synthetic */ class AnonymousClass2 extends FunctionReferenceImpl implements Function1<ValueParameterDescriptor, Boolean> {
    ...
    public static final ClassDescriptor getAnnotationClass(AnnotationDescriptor annotationDescriptor) {
        ...
        ClassifierDescriptor classifierDescriptorMo2061getDeclarationDescriptor = annotationDescriptor.getType().getConstructor().mo2061getDeclarationDescriptor();

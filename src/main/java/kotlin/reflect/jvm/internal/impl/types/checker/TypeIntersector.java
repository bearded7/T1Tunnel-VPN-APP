    ...
    public final SimpleType intersectTypes$descriptors(List<? extends SimpleType> types) {
        ...
        for (SimpleType simpleType : types) {
            if (simpleType.getConstructor() instanceof IntersectionTypeConstructor) {
                Collection<KotlinType> collectionMo2062getSupertypes = simpleType.getConstructor().mo2062getSupertypes();
                Intrinsics.checkNotNullExpressionValue(collectionMo2062getSupertypes, "getSupertypes(...)");
                Collection<KotlinType> collection = collectionMo2062getSupertypes;

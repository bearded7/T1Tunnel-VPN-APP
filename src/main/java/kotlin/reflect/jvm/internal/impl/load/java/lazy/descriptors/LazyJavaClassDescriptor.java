...
public final class LazyJavaClassDescriptor extends ClassDescriptorBase implements JavaClassDescriptor {
    ...
    public Collection<ClassDescriptor> getSealedSubclasses() {
        if (this.modality == Modality.SEALED) {
            ...
            while (it.hasNext()) {
                ClassifierDescriptor classifierDescriptorMo2061getDeclarationDescriptor = this.c.getTypeResolver().transformJavaType(it.next(), attributes$default).getConstructor().mo2061getDeclarationDescriptor();
    ...
    final class LazyJavaClassTypeConstructor extends AbstractClassTypeConstructor {
        ...
        public LazyJavaClassTypeConstructor() {
            ...
            this.parameters = LazyJavaClassDescriptor.this.c.getStorageManager().createLazyValue(new Function0(LazyJavaClassDescriptor.this) { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaClassDescriptor$LazyJavaClassTypeConstructor$$Lambda$0
                ...
                @Override // kotlin.jvm.functions.Function0
                public Object invoke() {
                    return LazyJavaClassDescriptor.LazyJavaClassTypeConstructor.parameters$lambda$0(this.arg$0);
                }
            });
        }
        ...
        protected Collection<KotlinType> computeSupertypes() {
            ...
            while (true) {
                ...
                if (kotlinTypeEnhanceSuperType.getConstructor().mo2061getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor) {
                    arrayList2.add(next);
                }
            ...
            if (!arrayList2.isEmpty()) {
                ...
                ClassDescriptor classDescriptorMo2061getDeclarationDescriptor = mo2061getDeclarationDescriptor();
                ...
                errorReporter.reportIncompleteHierarchy(classDescriptorMo2061getDeclarationDescriptor, arrayList5);
            }
        ...
        private final FqName getPurelyImplementsFqNameFromAnnotation() {
            ...
            AnnotationDescriptor annotationDescriptorMo2056findAnnotation = annotations.mo2056findAnnotation(PURELY_IMPLEMENTS_ANNOTATION);
            if (annotationDescriptorMo2056findAnnotation == null) {
                return null;
            }
            Object objSingleOrNull = CollectionsKt.singleOrNull(annotationDescriptorMo2056findAnnotation.getAllValueArguments().values());
        ...
        public ClassDescriptor mo2061getDeclarationDescriptor() {

...
public abstract class KotlinTypePreparator extends AbstractTypePreparator {
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> collectionMo2062getSupertypes = capturedTypeConstructorImpl.mo2062getSupertypes();
                ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo2062getSupertypes, 10));
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> collectionMo2062getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo2062getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo2062getSupertypes2, 10));
            Iterator<T> it2 = collectionMo2062getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> collectionMo2062getSupertypes3 = intersectionTypeConstructor.mo2062getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo2062getSupertypes3, 10));
        Iterator<T> it3 = collectionMo2062getSupertypes3.iterator();
        while (it3.hasNext()) {
    ...
    /* JADX INFO: compiled from: KotlinTypePreparator.kt */
    /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function1<KotlinTypeMarker, UnwrappedType> {

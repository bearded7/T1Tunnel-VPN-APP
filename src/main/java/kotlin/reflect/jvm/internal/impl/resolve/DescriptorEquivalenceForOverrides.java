...
public final class DescriptorEquivalenceForOverrides {
    ...
    public static final boolean areCallableDescriptorsEquivalent$lambda$3(boolean z, final CallableDescriptor callableDescriptor, final CallableDescriptor callableDescriptor2, TypeConstructor c1, TypeConstructor c2) {
        ...
        ClassifierDescriptor classifierDescriptorMo2061getDeclarationDescriptor = c1.mo2061getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo2061getDeclarationDescriptor2 = c2.mo2061getDeclarationDescriptor();
        if ((classifierDescriptorMo2061getDeclarationDescriptor instanceof TypeParameterDescriptor) && (classifierDescriptorMo2061getDeclarationDescriptor2 instanceof TypeParameterDescriptor)) {
            return INSTANCE.areTypeParametersEquivalent((TypeParameterDescriptor) classifierDescriptorMo2061getDeclarationDescriptor, (TypeParameterDescriptor) classifierDescriptorMo2061getDeclarationDescriptor2, z, new Function2(callableDescriptor, callableDescriptor2) { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$$Lambda$3

...
public final class NewCapturedTypeConstructor implements CapturedTypeConstructor {
    ...
    public List<UnwrappedType> mo2062getSupertypes() {
    ...
    public static final List refine$lambda$6$lambda$5(NewCapturedTypeConstructor newCapturedTypeConstructor, KotlinTypeRefiner kotlinTypeRefiner) {
        List<UnwrappedType> listMo2062getSupertypes = newCapturedTypeConstructor.mo2062getSupertypes();
        ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(listMo2062getSupertypes, 10));
        Iterator<T> it = listMo2062getSupertypes.iterator();
        while (it.hasNext()) {

...
public abstract class ClassifierBasedTypeConstructor implements TypeConstructor {
    ...
    public abstract ClassifierDescriptor mo2061getDeclarationDescriptor();
    ...
    public int hashCode() {
        ...
        ClassifierDescriptor classifierDescriptorMo2061getDeclarationDescriptor = mo2061getDeclarationDescriptor();
        if (hasMeaningfulFqName(classifierDescriptorMo2061getDeclarationDescriptor)) {
            iIdentityHashCode = DescriptorUtils.getFqName(classifierDescriptorMo2061getDeclarationDescriptor).hashCode();
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        ClassifierDescriptor classifierDescriptorMo2061getDeclarationDescriptor = mo2061getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo2061getDeclarationDescriptor2 = typeConstructor.mo2061getDeclarationDescriptor();
        if (classifierDescriptorMo2061getDeclarationDescriptor2 != null && hasMeaningfulFqName(classifierDescriptorMo2061getDeclarationDescriptor) && hasMeaningfulFqName(classifierDescriptorMo2061getDeclarationDescriptor2)) {
            return isSameClassifier(classifierDescriptorMo2061getDeclarationDescriptor2);
        }
        return false;
    }

...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    private final void renderDefaultType(StringBuilder sb, KotlinType kotlinType) {
        ...
        if (KotlinTypeKt.isError(kotlinType)) {
            ...
            if (original instanceof StubTypeForBuilderInference) {
    ...
    public String renderTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassifierDescriptor classifierDescriptorMo2061getDeclarationDescriptor = typeConstructor.mo2061getDeclarationDescriptor();
        if ((classifierDescriptorMo2061getDeclarationDescriptor instanceof TypeParameterDescriptor) || (classifierDescriptorMo2061getDeclarationDescriptor instanceof ClassDescriptor) || (classifierDescriptorMo2061getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            return renderClassifierName(classifierDescriptorMo2061getDeclarationDescriptor);
        }
        if (classifierDescriptorMo2061getDeclarationDescriptor == null) {
        ...
        throw new IllegalStateException(("Unexpected classifier: " + classifierDescriptorMo2061getDeclarationDescriptor.getClass()).toString());
    }
    ...
    private final void appendTypeProjections(StringBuilder sb, List<? extends TypeProjection> list) {
        CollectionsKt.joinTo(list, sb, (112 & 2) != 0 ? ", " : ", ", (112 & 4) != 0 ? "" : null, (112 & 8) != 0 ? "" : null, (112 & 16) != 0 ? -1 : 0, (112 & 32) != 0 ? "..." : null, (112 & 64) != 0 ? null : new Function1(this) { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$$Lambda$2
            private final DescriptorRendererImpl arg$0;
    ...
    public String renderAnnotation(AnnotationDescriptor annotation, AnnotationUseSiteTarget annotationUseSiteTarget) {
        ...
        if (getIncludeAnnotationArguments()) {
            ...
            if (getIncludeEmptyAnnotationArguments() || !listRenderAndSortAnnotationArguments.isEmpty()) {
                CollectionsKt.joinTo(listRenderAndSortAnnotationArguments, sb, (112 & 2) != 0 ? ", " : ", ", (112 & 4) != 0 ? "" : "(", (112 & 8) != 0 ? "" : ")", (112 & 16) != 0 ? -1 : 0, (112 & 32) != 0 ? "..." : null, (112 & 64) != 0 ? null : null);
            }
        }
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo2061getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ClassConstructorDescriptor classConstructorDescriptorMo2055getUnsubstitutedPrimaryConstructor;
        ...
        if (annotationClass != null && (classConstructorDescriptorMo2055getUnsubstitutedPrimaryConstructor = annotationClass.mo2055getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = classConstructorDescriptorMo2055getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
    ...
    /* JADX WARN: Code duplicated, block: B:29:0x0072 A[EDGE_INSN: B:29:0x0072->B:30:0x0073 BREAK  A[LOOP:1: B:22:0x0059->B:37:?]] */
    ...
    public final void renderConstructor(ConstructorDescriptor constructorDescriptor, StringBuilder sb) {
        ...
        if (getRenderConstructorDelegation() && !constructorDescriptor.isPrimary() && (containingDeclaration instanceof ClassDescriptor) && (classConstructorDescriptorMo2055getUnsubstitutedPrimaryConstructor = ((ClassDescriptor) containingDeclaration).mo2055getUnsubstitutedPrimaryConstructor()) != null) {
            List<ValueParameterDescriptor> valueParameters2 = classConstructorDescriptorMo2055getUnsubstitutedPrimaryConstructor.getValueParameters();
    ...
    private final void renderWhereSuffix(List<? extends TypeParameterDescriptor> list, StringBuilder sb) {
        ...
        CollectionsKt.joinTo(arrayList, sb, (112 & 2) != 0 ? ", " : ", ", (112 & 4) != 0 ? "" : null, (112 & 8) != 0 ? "" : null, (112 & 16) != 0 ? -1 : 0, (112 & 32) != 0 ? "..." : null, (112 & 64) != 0 ? null : null);
    }
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ConstantValue<?> constantValueMo2057getCompileTimeInitializer;
        String strRenderConstant;
        if (!getIncludePropertyConstant() || (constantValueMo2057getCompileTimeInitializer = variableDescriptor.mo2057getCompileTimeInitializer()) == null || (strRenderConstant = renderConstant(constantValueMo2057getCompileTimeInitializer)) == null) {
            return;
        }
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (classConstructorDescriptorMo2055getUnsubstitutedPrimaryConstructor = classDescriptor.mo2055getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(" ");
            renderAnnotations$default(this, sb, classConstructorDescriptorMo2055getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = classConstructorDescriptorMo2055getUnsubstitutedPrimaryConstructor.getVisibility();
            Intrinsics.checkNotNullExpressionValue(visibility2, "getVisibility(...)");
            renderVisibility(visibility2, sb);
            sb.append(renderKeyword("constructor"));
            List<ValueParameterDescriptor> valueParameters = classConstructorDescriptorMo2055getUnsubstitutedPrimaryConstructor.getValueParameters();
            Intrinsics.checkNotNullExpressionValue(valueParameters, "getValueParameters(...)");
            renderValueParameters(valueParameters, classConstructorDescriptorMo2055getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        Collection<KotlinType> collectionMo2062getSupertypes = classDescriptor.getTypeConstructor().mo2062getSupertypes();
        Intrinsics.checkNotNullExpressionValue(collectionMo2062getSupertypes, "getSupertypes(...)");
        if (collectionMo2062getSupertypes.isEmpty()) {
            return;
        }
        if (collectionMo2062getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(collectionMo2062getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt.joinTo(collectionMo2062getSupertypes, sb, (112 & 2) != 0 ? ", " : ", ", (112 & 4) != 0 ? "" : null, (112 & 8) != 0 ? "" : null, (112 & 16) != 0 ? -1 : 0, (112 & 32) != 0 ? "..." : null, (112 & 64) != 0 ? null : new Function1(this) { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$$Lambda$4
            private final DescriptorRendererImpl arg$0;

...
public final class UtilsKt {
    public static final KotlinType findCorrespondingSupertype(KotlinType subtype, KotlinType supertype, TypeCheckingProcedureCallbacks typeCheckingProcedureCallbacks) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            for (KotlinType kotlinType : constructor2.mo2062getSupertypes()) {
    ...
    private static final String debugInfo(TypeConstructor typeConstructor) {
        ...
        for (ClassifierDescriptor classifierDescriptorMo2061getDeclarationDescriptor = typeConstructor.mo2061getDeclarationDescriptor(); classifierDescriptorMo2061getDeclarationDescriptor != null; classifierDescriptorMo2061getDeclarationDescriptor = classifierDescriptorMo2061getDeclarationDescriptor.getContainingDeclaration()) {
            debugInfo$lambda$1$unaryPlus("fqName: " + DescriptorRenderer.FQ_NAMES_IN_TYPES.render(classifierDescriptorMo2061getDeclarationDescriptor), sb);
            debugInfo$lambda$1$unaryPlus("javaClass: " + classifierDescriptorMo2061getDeclarationDescriptor.getClass().getCanonicalName(), sb);
        }
        return sb.toString();
    }

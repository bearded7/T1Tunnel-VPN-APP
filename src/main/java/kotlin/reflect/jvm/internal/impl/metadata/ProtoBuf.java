    ...
    public static final class Class extends GeneratedMessageLite.ExtendableMessage<Class> implements ClassOrBuilder {
        ...
        /*  JADX ERROR: Types fix failed
            ...
            Caused by: java.lang.NullPointerException: Cannot invoke "jadx.core.dex.instructions.args.InsnArg.getType()" because "arg" is null
            	...
            	... 5 more
            */
        private Class(kotlin.reflect.jvm.internal.impl.protobuf.CodedInputStream r23, kotlin.reflect.jvm.internal.impl.protobuf.ExtensionRegistryLite r24) throws kotlin.reflect.jvm.internal.impl.protobuf.InvalidProtocolBufferException {
            /*
                    ...
                    try {
                        ...
                        if (tag != 0) {
                            if (tag == 8) {
                                ...
                                this.compilerPluginData_.add((CompilerPluginData) codedInputStream.readMessage(CompilerPluginData.PARSER, extensionRegistryLite));
                            }
                        }
                        z = true;
                    } catch (InvalidProtocolBufferException e) {
                    ...
                    try {
                        ...
                        switch (tag) {
                            ...
                            case RotationOptions.ROTATE_90 /* 90 */:
                                ...
                                i = i;
                                if (i6 != 512 && codedInputStream.getBytesUntilLimit() > 0) {
                                    i = i;
                                    this.contextReceiverTypeId_ = new ArrayList();
                                    i = (i == true ? 1 : 0) | 512;
                                }
                            ...
                            case ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION /* 250 */:
                                ...
                                i = i;
                                if (i8 != 4096 && codedInputStream.getBytesUntilLimit() > 0) {
                                    i = i;
                                    this.versionRequirement_ = new ArrayList();
                                    i = (i == true ? 1 : 0) | 4096;
                                }
                    ...
                    try {
                        ...
                        switch (tag) {
                            ...
                            case 106:
                                ...
                                int i5 = (i == true ? 1 : 0) & 512;
                                i = i;
                                if (i5 != 512 && codedInputStream.getBytesUntilLimit() > 0) {
                                    i = i;
                                    this.contextReceiverTypeId_ = new ArrayList();
                                    i = (i == true ? 1 : 0) | 512;
                                }
                            ...
                            case ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION /* 250 */:
                                ...
                                i = i;
                                if (i7 != 8192 && codedInputStream.getBytesUntilLimit() > 0) {
                                    i = i;
                                    this.versionRequirement_ = new ArrayList();
                                    i = (i == true ? 1 : 0) | 8192;
                                }

...
public final class ClassId {
    ...
    private static final String asString$escapeSlashes(FqName fqName) {
        ...
        return StringsKt.contains$default((CharSequence) strAsString, IOUtils.DIR_SEPARATOR_UNIX, false, 2, (Object) null) ? "`" + strAsString + '`' : strAsString;
    }
    ...
    public static final class Companion {
        ...
        public final ClassId fromString(String string, boolean z) {
            ...
            if (iLastIndexOf$default == -1) {
                ...
                String strReplace$default2 = StringsKt.replace$default(strSubstring, IOUtils.DIR_SEPARATOR_UNIX, FilenameUtils.EXTENSION_SEPARATOR, false, 4, (Object) null);

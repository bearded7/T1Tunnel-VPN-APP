...
public interface ResolutionScope {
    ...
    ClassifierDescriptor mo2063getContributedClassifier(Name name, LookupLocation lookupLocation);
    ...
    void mo2067recordLookup(Name name, LookupLocation lookupLocation);

...
public final class TypeUtilsKt {
    ...
    private static final void extractTypeParametersFromUpperBounds(KotlinType kotlinType, KotlinType kotlinType2, Set<TypeParameterDescriptor> set, Set<? extends TypeParameterDescriptor> set2) {
        ClassifierDescriptor classifierDescriptorMo2061getDeclarationDescriptor = kotlinType.getConstructor().mo2061getDeclarationDescriptor();
        if (classifierDescriptorMo2061getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            if (!Intrinsics.areEqual(kotlinType.getConstructor(), kotlinType2.getConstructor())) {
                set.add(classifierDescriptorMo2061getDeclarationDescriptor);
                return;
            }
            for (KotlinType kotlinType3 : ((TypeParameterDescriptor) classifierDescriptorMo2061getDeclarationDescriptor).getUpperBounds()) {
                Intrinsics.checkNotNull(kotlinType3);
                extractTypeParametersFromUpperBounds(kotlinType3, kotlinType2, set, set2);
            }
            return;
        }
        ClassifierDescriptor classifierDescriptorMo2061getDeclarationDescriptor2 = kotlinType.getConstructor().mo2061getDeclarationDescriptor();
        ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters = classifierDescriptorMo2061getDeclarationDescriptor2 instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) classifierDescriptorMo2061getDeclarationDescriptor2 : null;
        ...
        for (TypeProjection typeProjection : kotlinType.getArguments()) {
            ...
            if ((typeParameterDescriptor == null || set2 == null || !set2.contains(typeParameterDescriptor)) && !typeProjection.isStarProjection() && !CollectionsKt.contains(set, typeProjection.getType().getConstructor().mo2061getDeclarationDescriptor()) && !Intrinsics.areEqual(typeProjection.getType().getConstructor(), kotlinType2.getConstructor())) {
    ...
    private static final boolean containsSelfTypeParameter(KotlinType kotlinType, TypeConstructor typeConstructor, Set<? extends TypeParameterDescriptor> set) {
        ...
        ClassifierDescriptor classifierDescriptorMo2061getDeclarationDescriptor = kotlinType.getConstructor().mo2061getDeclarationDescriptor();
        ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters = classifierDescriptorMo2061getDeclarationDescriptor instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) classifierDescriptorMo2061getDeclarationDescriptor : null;
        List<TypeParameterDescriptor> declaredTypeParameters = classifierDescriptorWithTypeParameters != null ? classifierDescriptorWithTypeParameters.getDeclaredTypeParameters() : null;
    ...
    public static final boolean containsTypeAliasParameters$lambda$13(UnwrappedType it) {
        ...
        ClassifierDescriptor classifierDescriptorMo2061getDeclarationDescriptor = it.getConstructor().mo2061getDeclarationDescriptor();
        if (classifierDescriptorMo2061getDeclarationDescriptor != null) {
            return isTypeAliasParameter(classifierDescriptorMo2061getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean requiresTypeAliasExpansion$lambda$16(UnwrappedType it) {
        ...
        ClassifierDescriptor classifierDescriptorMo2061getDeclarationDescriptor = it.getConstructor().mo2061getDeclarationDescriptor();
        if (classifierDescriptorMo2061getDeclarationDescriptor != null) {
            return (classifierDescriptorMo2061getDeclarationDescriptor instanceof TypeAliasDescriptor) || (classifierDescriptorMo2061getDeclarationDescriptor instanceof TypeParameterDescriptor);
        }
        return false;
    }
    ...
    public static final KotlinType getRepresentativeUpperBound(TypeParameterDescriptor typeParameterDescriptor) {
        ...
        while (true) {
            ...
            Object next = it.next();
            ClassifierDescriptor classifierDescriptorMo2061getDeclarationDescriptor = ((KotlinType) next).getConstructor().mo2061getDeclarationDescriptor();
            ClassDescriptor classDescriptor = classifierDescriptorMo2061getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo2061getDeclarationDescriptor : null;
    ...
    public static final KotlinType replaceArgumentsWithStarProjections(KotlinType kotlinType) {
        ...
        if (unwrappedTypeUnwrap instanceof FlexibleType) {
            ...
            if (!lowerBound.getConstructor().getParameters().isEmpty() && lowerBound.getConstructor().mo2061getDeclarationDescriptor() != null) {
            ...
            if (!upperBound.getConstructor().getParameters().isEmpty() && upperBound.getConstructor().mo2061getDeclarationDescriptor() != null) {
            ...
            if (!simpleTypeReplace$default.getConstructor().getParameters().isEmpty() && simpleTypeReplace$default.getConstructor().mo2061getDeclarationDescriptor() != null) {

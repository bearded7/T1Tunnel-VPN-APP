...
public final class ChainedMemberScope implements MemberScope {
    ...
    public ClassifierDescriptor mo2063getContributedClassifier(Name name, LookupLocation location) {
        ...
        for (MemberScope memberScope : this.scopes) {
            ClassifierDescriptor classifierDescriptorMo2063getContributedClassifier = memberScope.mo2063getContributedClassifier(name, location);
            if (classifierDescriptorMo2063getContributedClassifier != null) {
                if (!(classifierDescriptorMo2063getContributedClassifier instanceof ClassifierDescriptorWithTypeParameters) || !((MemberDescriptor) classifierDescriptorMo2063getContributedClassifier).isExpect()) {
                    return classifierDescriptorMo2063getContributedClassifier;
                }
                if (classifierDescriptor == null) {
                    classifierDescriptor = classifierDescriptorMo2063getContributedClassifier;
                }
            }
        }
    ...
    public void mo2067recordLookup(Name name, LookupLocation location) {
        ...
        Intrinsics.checkNotNullParameter(location, "location");
        for (MemberScope memberScope : this.scopes) {
            memberScope.mo2067recordLookup(name, location);
        }
    }

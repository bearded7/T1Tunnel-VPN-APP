...
public final class CapturedTypeConstructorKt {
    ...
    public static final TypeSubstitution wrapWithCapturingSubstitution(TypeSubstitution typeSubstitution, final boolean z) {
        ...
        return new DelegatedTypeSubstitution(typeSubstitution) { // from class: kotlin.reflect.jvm.internal.impl.resolve.calls.inference.CapturedTypeConstructorKt.wrapWithCapturingSubstitution.2
            ...
            public TypeProjection mo2066get(KotlinType key) {
                Intrinsics.checkNotNullParameter(key, "key");
                TypeProjection typeProjectionMo2066get = super.mo2066get(key);
                if (typeProjectionMo2066get == null) {
                    return null;
                }
                ClassifierDescriptor classifierDescriptorMo2061getDeclarationDescriptor = key.getConstructor().mo2061getDeclarationDescriptor();
                return CapturedTypeConstructorKt.createCapturedIfNeeded(typeProjectionMo2066get, classifierDescriptorMo2061getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) classifierDescriptorMo2061getDeclarationDescriptor : null);
            }
        };
    }

...
public final class InlineClassesUtilsKt {
    ...
    public static final boolean isInlineClassType(KotlinType kotlinType) {
        ...
        if (classifierDescriptorMo2061getDeclarationDescriptor != null) {
            return isInlineClass(classifierDescriptorMo2061getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean isValueClassType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo2061getDeclarationDescriptor = kotlinType.getConstructor().mo2061getDeclarationDescriptor();
        if (classifierDescriptorMo2061getDeclarationDescriptor != null) {
            return isValueClass(classifierDescriptorMo2061getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean needsMfvcFlattening(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor classifierDescriptorMo2061getDeclarationDescriptor = kotlinType.getConstructor().mo2061getDeclarationDescriptor();
        return (classifierDescriptorMo2061getDeclarationDescriptor == null || !isMultiFieldValueClass(classifierDescriptorMo2061getDeclarationDescriptor) || SimpleClassicTypeSystemContext.INSTANCE.isNullableType(kotlinType)) ? false : true;
    }

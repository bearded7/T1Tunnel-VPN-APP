...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo2063getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassDescriptor classDescriptorMo2063getContributedClassifier = this.javaScope.mo2063getContributedClassifier(name, location);
        if (classDescriptorMo2063getContributedClassifier != null) {
            return classDescriptorMo2063getContributedClassifier;
        }
        ClassifierDescriptor classifierDescriptor = null;
        for (MemberScope memberScope : getKotlinScopes()) {
            ClassifierDescriptor contributedClassifier = memberScope.mo2063getContributedClassifier(name, location);

    ...
    public static final boolean isAccessible(KCallable<?> kCallable) {
        ...
        if (kCallable instanceof KFunction) {
            ...
            if (javaMethod3 != null ? javaMethod3.isAccessible() : true) {
                ...
                Member memberMo2053getMember = (kCallableImplAsKCallableImpl == null || (defaultCaller = kCallableImplAsKCallableImpl.getDefaultCaller()) == null) ? null : defaultCaller.mo2053getMember();
                AccessibleObject accessibleObject = memberMo2053getMember instanceof AccessibleObject ? (AccessibleObject) memberMo2053getMember : null;

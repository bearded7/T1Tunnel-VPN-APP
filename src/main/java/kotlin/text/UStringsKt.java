...
public final class UStringsKt {
    ...
    public static final String m2121toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m2123toStringolVBNx4(short s, int i) {
    ...
    public static final String m2122toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m2120toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m869constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m784boximpl(UByte.m790constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m869constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m1049boximpl(UShort.m1055constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM869constructorimpl = UInt.m869constructorimpl(i);
        int iM = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                if (iM == 119304647) {
                    iM = UByte$$ExternalSyntheticBackport0.m(-1, iM869constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM869constructorimpl2 = UInt.m869constructorimpl(i3 * iM869constructorimpl);
            int iM869constructorimpl3 = UInt.m869constructorimpl(UInt.m869constructorimpl(iDigitOf) + iM869constructorimpl2);
            if (Integer.compare(iM869constructorimpl3 ^ Integer.MIN_VALUE, iM869constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM869constructorimpl3;
        }
        return UInt.m863boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM948constructorimpl = ULong.m948constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM948constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM948constructorimpl2 = ULong.m948constructorimpl(j * jM948constructorimpl);
            long jM948constructorimpl3 = ULong.m948constructorimpl(ULong.m948constructorimpl(((long) UInt.m869constructorimpl(iDigitOf)) & 4294967295L) + jM948constructorimpl2);
            if (Long.compare(jM948constructorimpl3 ^ Long.MIN_VALUE, jM948constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM948constructorimpl3;
        }
        return ULong.m942boximpl(j);
    }
}

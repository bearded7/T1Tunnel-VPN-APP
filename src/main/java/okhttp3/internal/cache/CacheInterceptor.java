    ...
    public static final class Companion {
        ...
        public final Headers combine(Headers cachedHeaders, Headers networkHeaders) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if ((!StringsKt.equals(com.google.common.net.HttpHeaders.WARNING, strName, true) || !StringsKt.startsWith$default(strValue, coil3.disk.DiskLruCache.VERSION, false, 2, (Object) null)) && (isContentSpecificHeader(strName) || !isEndToEnd(strName) || networkHeaders.get(strName) == null)) {
        ...
        private final boolean isEndToEnd(String fieldName) {
            return (StringsKt.equals(com.google.common.net.HttpHeaders.CONNECTION, fieldName, true) || StringsKt.equals("Keep-Alive", fieldName, true) || StringsKt.equals(com.google.common.net.HttpHeaders.PROXY_AUTHENTICATE, fieldName, true) || StringsKt.equals(com.google.common.net.HttpHeaders.PROXY_AUTHORIZATION, fieldName, true) || StringsKt.equals(com.google.common.net.HttpHeaders.TE, fieldName, true) || StringsKt.equals("Trailers", fieldName, true) || StringsKt.equals(com.google.common.net.HttpHeaders.TRANSFER_ENCODING, fieldName, true) || StringsKt.equals(com.google.common.net.HttpHeaders.UPGRADE, fieldName, true)) ? false : true;
        }

...
final /* synthetic */ class FlowKt__ReduceKt {
    ...
    static final class C02411<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;
    ...
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0, 0}, l = {179}, m = "firstOrNull", n = {"result", "collector$iv"}, s = {"L$0", "L$1"})
    static final class C02423<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        C02423(Continuation<? super C02423> continuation) {
            super(continuation);
        }
    ...
    static final class C02431<T, R> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C02441<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C02461<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C02481<S, T extends S> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C02501<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    public static final <S, T extends S> Object reduce(Flow<? extends T> flow, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3, Continuation<? super S> continuation) {
        ...
        if (i == 0) {
            ...
            FlowCollector<? super Object> c02492 = new C02492<>(objectRef2, function3);
            c02481.L$0 = objectRef2;
            c02481.label = 1;
            if (flow.collect(c02492, c02481) == coroutine_suspended) {
            ...
            objectRef = (Ref.ObjectRef) c02481.L$0;
            ResultKt.throwOnFailure(obj);
        }
    ...
    /* JADX INFO: compiled from: Reduce.kt */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 48)
    static final class C02492<T> implements FlowCollector {
        final /* synthetic */ Ref.ObjectRef<Object> $accumulator;
        final /* synthetic */ Function3<S, T, Continuation<? super S>, Object> $operation;

        /* JADX WARN: Multi-variable type inference failed */
        C02492(Ref.ObjectRef<Object> objectRef, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3) {
    ...
    public static final <T, R> Object fold(Flow<? extends T> flow, R r, Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3, Continuation<? super R> continuation) {
        ...
        if (i == 0) {
            ...
            c02431.L$0 = objectRef2;
            c02431.label = 1;
            if (flow.collect(anonymousClass2, c02431) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c02431.L$0;
            ResultKt.throwOnFailure(obj);
        }
        return objectRef.element;
    }
    ...
    public static final <T> Object single(Flow<? extends T> flow, Continuation<? super T> continuation) {
        ...
        if (i == 0) {
            ...
            c02501.L$0 = objectRef2;
            c02501.label = 1;
            if (flow.collect(flowCollector, c02501) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c02501.L$0;
            ResultKt.throwOnFailure(obj);
        }
        if (objectRef.element == NullSurrogateKt.NULL) {
    ...
    public static final <T> Object singleOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) {
        ...
        if (i == 0) {
            ...
            try {
                c02521.L$0 = objectRef2;
                c02521.L$1 = flowCollector2;
                c02521.label = 1;
                if (flow.collect(flowCollector2, c02521) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            ...
            flowCollector = (FlowKt__ReduceKt$singleOrNull$$inlined$collectWhile$1) c02521.L$1;
            objectRef = (Ref.ObjectRef) c02521.L$0;
            try {
                ResultKt.throwOnFailure(obj);
    ...
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) {
        ...
        if (i == 0) {
            ...
            try {
                c02411.L$0 = objectRef2;
                c02411.L$1 = flowCollector2;
                c02411.label = 1;
                if (flow.collect(flowCollector2, c02411) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$1) c02411.L$1;
            objectRef = (Ref.ObjectRef) c02411.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super Boolean>, ? extends Object> function2, Continuation<? super T> continuation) {
        ...
        AbortFlowException e;
        FlowCollector<? super Object> flowCollector;
        if (continuation instanceof C02423) {
            c02423 = (C02423) continuation;
            if ((c02423.label & Integer.MIN_VALUE) != 0) {
                c02423.label -= Integer.MIN_VALUE;
            } else {
                c02423 = new C02423(continuation);
            }
        } else {
            c02423 = new C02423(continuation);
        }
        Object obj = c02423.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c02423.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            try {
                c02423.L$0 = objectRef2;
                c02423.L$1 = flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2;
                c02423.label = 1;
                if (flow.collect(flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2, c02423) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2) c02423.L$1;
            objectRef = (Ref.ObjectRef) c02423.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    public static final <T> Object last(Flow<? extends T> flow, Continuation<? super T> continuation) {
        ...
        if (i == 0) {
            ...
            c02441.L$0 = objectRef2;
            c02441.label = 1;
            if (flow.collect(flowCollector, c02441) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c02441.L$0;
            ResultKt.throwOnFailure(obj);
        }
        if (objectRef.element == NullSurrogateKt.NULL) {
            throw new NoSuchElementException("Expected at least one element");
    ...
    public static final <T> Object lastOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) {
        ...
        if (i == 0) {
            ...
            c02461.L$0 = objectRef2;
            c02461.label = 1;
            if (flow.collect(flowCollector, c02461) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c02461.L$0;
            ResultKt.throwOnFailure(obj);
        }
        return objectRef.element;
    }

        ...
        try {
            ...
            try {
                ...
                if (objWrapWithContinuationImpl != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    continuationProbeCoroutineCreated.resumeWith(Result.m772constructorimpl(objWrapWithContinuationImpl));
                }
            } catch (Throwable th) {
                ThreadContextKt.restoreThreadContext(context, objUpdateThreadContext);
                throw th;
            ...
            continuationProbeCoroutineCreated.resumeWith(Result.m772constructorimpl(ResultKt.createFailure(th2)));
        }
    }
}

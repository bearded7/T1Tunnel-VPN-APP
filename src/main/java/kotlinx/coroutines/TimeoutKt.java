...
public final class TimeoutKt {
    ...
    public static final TimeoutCancellationException TimeoutCancellationException(long j, Delay delay, Job job) {
        String strM2281timeoutMessageLRDsOJo;
        ...
        if (delayWithTimeoutDiagnostics != null) {
            ...
            strM2281timeoutMessageLRDsOJo = delayWithTimeoutDiagnostics.m2281timeoutMessageLRDsOJo(DurationKt.toDuration(j, DurationUnit.MILLISECONDS));
            if (strM2281timeoutMessageLRDsOJo == null) {
                strM2281timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
            }
        } else {
            strM2281timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
        }
        return new TimeoutCancellationException(strM2281timeoutMessageLRDsOJo, job);
    }
}

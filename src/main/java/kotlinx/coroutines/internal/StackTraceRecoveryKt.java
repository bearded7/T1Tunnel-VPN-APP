...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM772constructorimpl = Result.m772constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m775exceptionOrNullimpl(objM772constructorimpl) == null) {
            obj2 = objM772constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM772constructorimpl2 = Result.m772constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM772constructorimpl2 = Result.m772constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m775exceptionOrNullimpl(objM772constructorimpl2) == null) {
            obj = objM772constructorimpl2;
        }

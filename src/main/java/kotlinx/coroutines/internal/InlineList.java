...
public final class InlineList<E> {
    ...
    public static final /* synthetic */ InlineList m2346boximpl(Object obj) {
        return new InlineList(obj);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <E> Object m2347constructorimpl(Object obj) {
        return obj;
    }
    ...
    public boolean equals(Object other) {
        return m2349equalsimpl(this.holder, other);
    }

    public int hashCode() {
        return m2352hashCodeimpl(this.holder);
    }
    ...
    public static /* synthetic */ Object m2348constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m2347constructorimpl(obj);
    }

    /* JADX INFO: renamed from: plus-FjFbRPM, reason: not valid java name */
    public static final Object m2353plusFjFbRPM(Object obj, E e) {
        if (DebugKt.getASSERTIONS_ENABLED() && (e instanceof List)) {
            throw new AssertionError();
        }
        if (obj == null) {
            return m2347constructorimpl(e);
        }
    ...
    public static final void m2351forEachReversedimpl(Object obj, Function1<? super E, Unit> function1) {
        if (obj == null) {
            return;
        }
        if (!(obj instanceof ArrayList)) {

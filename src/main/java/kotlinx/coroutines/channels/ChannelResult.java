...
public final class ChannelResult<T> {
    ...
    public boolean equals(Object other) {
        return m2308equalsimpl(this.holder, other);
    }
    ...
    public static final T m2312getOrThrowimpl(Object obj) throws Throwable {
        if (!(obj instanceof Failed)) {
            return obj;
        }
    ...
    public static final class Companion {
        ...
        public final <E> Object m2321successJP2dKIU(E value) {
            return ChannelResult.m2307constructorimpl(value);
        }
        ...
        public final <E> Object m2319closedJP2dKIU(Throwable cause) {
            return ChannelResult.m2307constructorimpl(new Closed(cause));
        }
    }

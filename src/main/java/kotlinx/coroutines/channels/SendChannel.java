...
public interface SendChannel<E> {
    ...
    Object mo2291trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2316isSuccessimpl(objMo2291trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2310exceptionOrNullimpl = ChannelResult.m2310exceptionOrNullimpl(objMo2291trySendJP2dKIU);

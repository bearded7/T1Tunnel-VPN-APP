...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM2325trySendImplMj0NB7M = conflatedBufferedChannel.m2325trySendImplMj0NB7M(e, true);
        if (objM2325trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2310exceptionOrNullimpl(objM2325trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM2325trySendImplMj0NB7M = conflatedBufferedChannel.m2325trySendImplMj0NB7M(e, true);
        if (!(objM2325trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2291trySendJP2dKIU(E element) {
        return m2325trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2325trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2324trySendDropLatestMj0NB7M(element, isSendOp) : m2300trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2324trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo2291trySendJP2dKIU = super.mo2291trySendJP2dKIU(element);
        if (ChannelResult.m2316isSuccessimpl(objMo2291trySendJP2dKIU) || ChannelResult.m2314isClosedimpl(objMo2291trySendJP2dKIU)) {
            return objMo2291trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo2291trySendJP2dKIU = mo2291trySendJP2dKIU(element);
        if (!(objMo2291trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo2291trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2310exceptionOrNullimpl(objMo2291trySendJP2dKIU);

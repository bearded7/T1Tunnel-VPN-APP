...
public interface ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2299tryReceivePtdJZtk = receiveChannel.mo2299tryReceivePtdJZtk();
            if (ChannelResult.m2316isSuccessimpl(objMo2299tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2312getOrThrowimpl(objMo2299tryReceivePtdJZtk);
            }
            Throwable thM2310exceptionOrNullimpl = ChannelResult.m2310exceptionOrNullimpl(objMo2299tryReceivePtdJZtk);
            if (thM2310exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2310exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            Object objMo2298receiveCatchingJP2dKIU;
            ...
            if (i == 0) {
                ...
                objMo2298receiveCatchingJP2dKIU = receiveChannel.mo2298receiveCatchingJP2dKIU(anonymousClass1);
                if (objMo2298receiveCatchingJP2dKIU == coroutine_suspended) {
                ...
                ResultKt.throwOnFailure(obj);
                objMo2298receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
            }
            return ChannelResult.m2311getOrNullimpl(objMo2298receiveCatchingJP2dKIU);
        }

...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return ChannelResult.m2306boximpl(Result.m779isSuccessimpl(objM772constructorimpl) ? ChannelResult.INSTANCE.m2321successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2319closedJP2dKIU(Result.m775exceptionOrNullimpl(objM772constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo2291trySendJP2dKIU = sendChannel.mo2291trySendJP2dKIU(e);
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) throws InterruptedException {
        if (ChannelResult.m2316isSuccessimpl(sendChannel.mo2291trySendJP2dKIU(obj))) {
            return;
        }

...
public final class DelayKt {
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2358scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m2279delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2280toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2280toDelayMillisLRDsOJo(long j) {
        boolean zM2161isPositiveimpl = Duration.m2161isPositiveimpl(j);
        if (zM2161isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m2145getInWholeMillisecondsimpl(Duration.m2163plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM2161isPositiveimpl) {

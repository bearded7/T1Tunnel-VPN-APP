...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM772constructorimpl = Result.m772constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM772constructorimpl = Result.m772constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m778isFailureimpl(objM772constructorimpl) ? null : objM772constructorimpl);

...
public class SelectImplementation<R> implements CancelHandler, SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    static final class C02531 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02531(SelectImplementation<R> selectImplementation, Continuation<? super C02531> continuation) {
            super(continuation);
            this.this$0 = selectImplementation;
        }
    ...
    public final Object processResultAndInvokeBlockRecoveringException(SelectImplementation<R>.ClauseData clauseData, Object obj, Continuation<? super R> continuation) throws Throwable {
        ...
        if (continuation instanceof C02531) {
            ...
            if ((c02531.label & Integer.MIN_VALUE) != 0) {
                ...
                c02531 = new C02531(this, continuation);
            }
        } else {
            c02531 = new C02531(this, continuation);
        }
        ...
        try {
            ...
            c02531.label = 1;
            Object objInvokeBlock = clauseData.invokeBlock(objProcessResult, c02531);
            return objInvokeBlock == coroutine_suspended ? coroutine_suspended : objInvokeBlock;
        } catch (Throwable th) {
            if (DebugKt.getRECOVER_STACK_TRACES() && (c02531 instanceof CoroutineStackFrame)) {
                throw StackTraceRecoveryKt.recoverFromStackFrame(th, c02531);
            }
            throw th;
        }
    }

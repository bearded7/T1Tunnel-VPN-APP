...
public final class RealInterceptorChain implements Interceptor.Chain {
    ...
    @DebugMetadata(c = "coil3.intercept.RealInterceptorChain", f = "RealInterceptorChain.kt", i = {0, 0}, l = {ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_WIDTH_DEFAULT}, m = "proceed", n = {"this", "interceptor"}, s = {"L$0", "L$1"})

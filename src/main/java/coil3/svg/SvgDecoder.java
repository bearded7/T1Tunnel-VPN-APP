...
public final class SvgDecoder implements Decoder {
    ...
    public static final DecodeResult decode$lambda$0(SvgDecoder svgDecoder) throws Throwable {
        ...
        if (th == null) {
            ...
            long jM112computeDstSizesEdh43o = DecodeUtils.m112computeDstSizesEdh43o(width > 0.0f ? MathKt.roundToInt(width) : 512, height > 0.0f ? MathKt.roundToInt(height) : 512, svgDecoder.options.getSize(), svgDecoder.options.getScale(), ImageRequestsKt.getMaxBitmapSize(svgDecoder.options));
            int iM170getFirstimpl = IntPair.m170getFirstimpl(jM112computeDstSizesEdh43o);
            int iM171getSecondimpl = IntPair.m171getSecondimpl(jM112computeDstSizesEdh43o);
            if (width > 0.0f && height > 0.0f) {
                float fComputeSizeMultiplier = DecodeUtils.computeSizeMultiplier(width, height, iM170getFirstimpl, iM171getSecondimpl, svgDecoder.options.getScale());
                int i = (int) (fComputeSizeMultiplier * width);
                iM171getSecondimpl = (int) (fComputeSizeMultiplier * height);
                if (viewBox == null) {
            ...
            BitmapImage bitmapImageAsImage = svg.asImage(iM170getFirstimpl, iM171getSecondimpl);

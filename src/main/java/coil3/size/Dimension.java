...
public interface Dimension {
    ...
    public static final class Pixels implements Dimension {
        ...
        public static final /* synthetic */ Pixels m155boximpl(int i) {
            return new Pixels(i);
        }

        /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
        public static boolean m157equalsimpl(int i, Object obj) {
            return (obj instanceof Pixels) && i == ((Pixels) obj).m161unboximpl();
        }
        ...
        public boolean equals(Object other) {
            return m157equalsimpl(this.px, other);
        }

        public int hashCode() {
            return m159hashCodeimpl(this.px);
        }

        public String toString() {
            return m160toStringimpl(this.px);
        }

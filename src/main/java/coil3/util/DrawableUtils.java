...
public final class DrawableUtils {
    ...
    public final Bitmap convertToBitmap(Drawable drawable, Bitmap.Config config, Size size, Scale scale, boolean allowInexactSize) {
        ...
        long jM112computeDstSizesEdh43o = DecodeUtils.m112computeDstSizesEdh43o(width, i, size, scale, Size.ORIGINAL);
        double dComputeSizeMultiplier = DecodeUtils.computeSizeMultiplier(width, i, IntPair.m170getFirstimpl(jM112computeDstSizesEdh43o), IntPair.m171getSecondimpl(jM112computeDstSizesEdh43o), scale);
    ...
    private final boolean isSizeValid(boolean allowInexactSize, Bitmap bitmap, Size size, Scale scale) {
        ...
        long jM112computeDstSizesEdh43o = DecodeUtils.m112computeDstSizesEdh43o(bitmap.getWidth(), bitmap.getHeight(), size, scale, Size.ORIGINAL);
        return DecodeUtils.computeSizeMultiplier(bitmap.getWidth(), bitmap.getHeight(), IntPair.m170getFirstimpl(jM112computeDstSizesEdh43o), IntPair.m171getSecondimpl(jM112computeDstSizesEdh43o), scale) == 1.0d;
    }
}

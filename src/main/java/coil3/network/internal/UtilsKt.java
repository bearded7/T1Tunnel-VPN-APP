...
public final class UtilsKt {
    ...
    @DebugMetadata(c = "coil3.network.internal.UtilsKt", f = "utils.kt", i = {0}, l = {ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_WIDTH_DEFAULT}, m = "readBuffer", n = {"buffer"}, s = {"L$1"})
    ...
    public static final void closeQuietly(AutoCloseable autoCloseable) {
        try {
            UByte$$ExternalSyntheticBackport0.m842m((Object) autoCloseable);

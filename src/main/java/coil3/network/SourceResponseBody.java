...
final class SourceResponseBody implements NetworkResponseBody {
    ...
    public static final /* synthetic */ SourceResponseBody m126boximpl(BufferedSource bufferedSource) {
        return new SourceResponseBody(bufferedSource);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static BufferedSource m128constructorimpl(BufferedSource bufferedSource) {
        return bufferedSource;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m129equalsimpl(BufferedSource bufferedSource, Object obj) {
        return (obj instanceof SourceResponseBody) && Intrinsics.areEqual(bufferedSource, ((SourceResponseBody) obj).getSource());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m130equalsimpl0(BufferedSource bufferedSource, BufferedSource bufferedSource2) {
        return Intrinsics.areEqual(bufferedSource, bufferedSource2);
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m131hashCodeimpl(BufferedSource bufferedSource) {
        return bufferedSource.hashCode();
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m132toStringimpl(BufferedSource bufferedSource) {
        return "SourceResponseBody(source=" + bufferedSource + ')';
    }

    public boolean equals(Object other) {
        return m129equalsimpl(this.source, other);
    }

    public int hashCode() {
        return m131hashCodeimpl(this.source);
    }

    public String toString() {
        return m132toStringimpl(this.source);
    }
    ...
    public Object writeTo(BufferedSink bufferedSink, Continuation<? super Unit> continuation) {
        return m133writeToimpl(this.source, bufferedSink, continuation);
    }

    /* JADX INFO: renamed from: writeTo-impl, reason: not valid java name */
    public static Object m133writeToimpl(BufferedSource bufferedSource, BufferedSink bufferedSink, Continuation<? super Unit> continuation) throws IOException {
    ...
    public Object writeTo(FileSystem fileSystem, Path path, Continuation<? super Unit> continuation) {
        return m134writeToimpl(this.source, fileSystem, path, continuation);
    }

    @Override // java.lang.AutoCloseable
    public void close() {
        m127closeimpl(this.source);
    }

    /* JADX INFO: renamed from: close-impl, reason: not valid java name */
    public static void m127closeimpl(BufferedSource bufferedSource) {
        bufferedSource.close();
    }

    /* JADX INFO: renamed from: writeTo-impl, reason: not valid java name */
    public static Object m134writeToimpl(BufferedSource bufferedSource, FileSystem fileSystem, Path path, Continuation<? super Unit> continuation) throws Throwable {

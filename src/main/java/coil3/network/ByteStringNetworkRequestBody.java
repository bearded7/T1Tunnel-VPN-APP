...
final class ByteStringNetworkRequestBody implements NetworkRequestBody {
    ...
    public static final /* synthetic */ ByteStringNetworkRequestBody m117boximpl(ByteString byteString) {
        return new ByteStringNetworkRequestBody(byteString);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static ByteString m118constructorimpl(ByteString byteString) {
        return byteString;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m119equalsimpl(ByteString byteString, Object obj) {
    ...
    public static final boolean m120equalsimpl0(ByteString byteString, ByteString byteString2) {
        return Intrinsics.areEqual(byteString, byteString2);
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m121hashCodeimpl(ByteString byteString) {
        return byteString.hashCode();
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m122toStringimpl(ByteString byteString) {
        return "ByteStringNetworkRequestBody(bytes=" + byteString + ')';
    }

    public boolean equals(Object other) {
        return m119equalsimpl(this.bytes, other);
    }

    public int hashCode() {
        return m121hashCodeimpl(this.bytes);
    }

    public String toString() {
        return m122toStringimpl(this.bytes);
    }
    ...
    public Object writeTo(BufferedSink bufferedSink, Continuation<? super Unit> continuation) {
        return m123writeToimpl(this.bytes, bufferedSink, continuation);
    }

    /* JADX INFO: renamed from: writeTo-impl, reason: not valid java name */
    public static Object m123writeToimpl(ByteString byteString, BufferedSink bufferedSink, Continuation<? super Unit> continuation) throws IOException {

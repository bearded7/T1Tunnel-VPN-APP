...
public final class BitmapFactoryDecoder implements Decoder {
    ...
    private final void configureScale(BitmapFactory.Options options, ExifData exifData) {
        ...
        long jM112computeDstSizesEdh43o = DecodeUtils.m112computeDstSizesEdh43o(i, i2, this.options.getSize(), this.options.getScale(), ImageRequestsKt.getMaxBitmapSize(this.options));
        ...
        options.inSampleSize = DecodeUtils.calculateInSampleSize(i, i2, iM170getFirstimpl, iM171getSecondimpl, this.options.getScale());
        double dComputeSizeMultiplier = DecodeUtils.computeSizeMultiplier(((double) i) / ((double) options.inSampleSize), ((double) i2) / ((double) options.inSampleSize), iM170getFirstimpl, iM171getSecondimpl, this.options.getScale());

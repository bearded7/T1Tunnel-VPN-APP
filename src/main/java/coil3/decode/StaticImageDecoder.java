            ...
            try {
                ...
                DecodeResult decodeResult = new DecodeResult(Image_androidKt.asImage$default(ImageDecoder.decodeBitmap(staticImageDecoder.source, new ImageDecoder.OnHeaderDecodedListener() { // from class: coil3.decode.StaticImageDecoder$decode$lambda$2$lambda$1$$inlined$decodeBitmap$1
                    ...
                    public final void onHeaderDecoded(ImageDecoder imageDecoder, ImageDecoder.ImageInfo imageInfo, ImageDecoder.Source source) {
                        ...
                        long jM112computeDstSizesEdh43o = DecodeUtils.m112computeDstSizesEdh43o(width, height, this.this$0.options.getSize(), this.this$0.options.getScale(), ImageRequestsKt.getMaxBitmapSize(this.this$0.options));
                        ...
                        if (width > 0 && height > 0 && (width != iM170getFirstimpl || height != iM171getSecondimpl)) {
                            double dComputeSizeMultiplier = DecodeUtils.computeSizeMultiplier(width, height, iM170getFirstimpl, iM171getSecondimpl, this.this$0.options.getScale());

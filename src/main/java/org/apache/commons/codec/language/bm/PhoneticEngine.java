...
public class PhoneticEngine {
    ...
    private PhonemeBuilder applyFinalRules(PhonemeBuilder phonemeBuilder, Map<String, List<Rule>> map) {
        ...
        for (Rule.Phoneme phoneme : phonemeBuilder.getPhonemes()) {
            ...
            while (i < string.length()) {
                ...
                RulesApplication rulesApplicationInvoke = new RulesApplication(map2, string, phonemeBuilder2, i, this.maxPhonemes).invoke();
    ...
    public String encode(String str, Languages.LanguageSet languageSet) {
        ...
        while (i < str3.length()) {
            RulesApplication rulesApplicationInvoke = new RulesApplication(instanceMap, str3, phonemeBuilderEmpty, i, this.maxPhonemes).invoke();
            i = rulesApplicationInvoke.getI();

...
public final class ReadableMapBuffer extends HybridClassBase implements MapBuffer {
    ...
    private final void readHeader() {
        ...
        this.count = m407readUnsignedShortBwKQO78(this.buffer.position()) & UShort.MAX_VALUE;
    }
    ...
    private final int getBucketIndexForKey(int intKey) {
        ...
        if (intKey <= kEY_RANGE$ReactAndroid_release.getLast() && first <= intKey) {
            short sM1055constructorimpl = UShort.m1055constructorimpl((short) intKey);
            int count = getCount() - 1;
            int i = 0;
            while (i <= count) {
                int i2 = (i + count) >>> 1;
                int iM407readUnsignedShortBwKQO78 = m407readUnsignedShortBwKQO78(getKeyOffsetForBucketIndex(i2)) & UShort.MAX_VALUE;
                int i3 = 65535 & sM1055constructorimpl;
                if (Intrinsics.compare(iM407readUnsignedShortBwKQO78, i3) < 0) {
                    i = i2 + 1;
                } else {
                    if (Intrinsics.compare(iM407readUnsignedShortBwKQO78, i3) <= 0) {
                        return i2;
    ...
    private final MapBuffer.DataType readDataType(int bucketIndex) {
        int iM407readUnsignedShortBwKQO78 = m407readUnsignedShortBwKQO78(getKeyOffsetForBucketIndex(bucketIndex) + 2) & UShort.MAX_VALUE;
        if (ReactNativeFeatureFlags.enableAndroidTextMeasurementOptimizations()) {
            return DATA_TYPES[iM407readUnsignedShortBwKQO78];
        }
        return MapBuffer.DataType.values()[iM407readUnsignedShortBwKQO78];
    }
    ...
    public final short m407readUnsignedShortBwKQO78(int bufferPosition) {
        return UShort.m1055constructorimpl(this.buffer.getShort(bufferPosition));
    }
    ...
    public String toString() {
        ...
        CollectionsKt.joinTo(this, sb, (112 & 2) != 0 ? ", " : null, (112 & 4) != 0 ? "" : null, (112 & 8) != 0 ? "" : null, (112 & 16) != 0 ? -1 : 0, (112 & 32) != 0 ? "..." : null, (112 & 64) != 0 ? null : new Function1() { // from class: com.facebook.react.common.mapbuffer.ReadableMapBuffer$$ExternalSyntheticLambda0
    ...
    private final class MapBufferEntry implements MapBuffer.Entry {
        ...
        public int getKey() {
            return ReadableMapBuffer.this.m407readUnsignedShortBwKQO78(this.bucketOffset) & UShort.MAX_VALUE;
        }

        @Override // com.facebook.react.common.mapbuffer.MapBuffer.Entry
        public MapBuffer.DataType getType() {
            return ReactNativeFeatureFlags.enableAndroidTextMeasurementOptimizations() ? ReadableMapBuffer.DATA_TYPES[65535 & ReadableMapBuffer.this.m407readUnsignedShortBwKQO78(this.bucketOffset + 2)] : MapBuffer.DataType.values()[65535 & ReadableMapBuffer.this.m407readUnsignedShortBwKQO78(this.bucketOffset + 2)];
        }

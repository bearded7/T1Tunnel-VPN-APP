...
public final class FileReaderModule extends NativeFileReaderModuleSpec {
    ...
    public void readAsDataURL(ReadableMap blob, Promise promise) {
        ...
        try {
            ...
            if (blob.hasKey(SVGParser.XML_STYLESHEET_ATTR_TYPE) && (string = blob.getString(SVGParser.XML_STYLESHEET_ATTR_TYPE)) != null && string.length() != 0) {
                sb.append(blob.getString(SVGParser.XML_STYLESHEET_ATTR_TYPE));
            } else {

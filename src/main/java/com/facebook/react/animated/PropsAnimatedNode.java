...
public final class PropsAnimatedNode extends AnimatedNode {
    ...
    public final View getConnectedView() {
        ...
        try {
            ...
            UIManager uIManager = this.connectedViewUIManager;
            objM772constructorimpl = Result.m772constructorimpl(uIManager != null ? uIManager.resolveView(this.connectedViewTag) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM772constructorimpl = Result.m772constructorimpl(ResultKt.createFailure(th));
        }
        return (View) (Result.m778isFailureimpl(objM772constructorimpl) ? null : objM772constructorimpl);
    }

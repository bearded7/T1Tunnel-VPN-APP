        ...
        try {
            ...
            for (int i = 0; i < argumentExtractorArr.length; i++) {
                try {
                    ...
                    throw new NativeArgumentsParseException(e.getMessage() + " (constructing arguments for " + str + " at argument index " + getAffectedRange(jSArgumentsNeeded, argumentExtractorArr[i].getJSArgumentsNeeded()) + ")", e);
                } catch (NullPointerException e2) {
                    throw new NativeArgumentsParseException(e2.getMessage() + " (constructing arguments for " + str + " at argument index " + getAffectedRange(jSArgumentsNeeded, argumentExtractorArr[i].getJSArgumentsNeeded()) + ")", e2);
                }
            }
            try {

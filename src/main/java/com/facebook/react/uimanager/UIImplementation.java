    ...
    public void manageChildren(int i, ReadableArray readableArray, ReadableArray readableArray2, ReadableArray readableArray3, ReadableArray readableArray4, ReadableArray readableArray5) {
        ...
        if (this.mViewOperationsEnabled) {
            synchronized (this.uiImplementationThreadLock) {
                ...
                if (size > 0) {
                    Assertions.assertNotNull(readableArray6);
                ...
                if (size2 > 0) {
                    ...
                    for (int i9 = 0; i9 < size2; i9++) {
                        viewAtIndexArr[i7 + i9] = new ViewAtIndex(readableArray3.getInt(i9), readableArray4.getInt(i9));
                    }
                }
                if (size3 > 0) {
                    ...
                    for (int i10 = 0; i10 < size3; i10++) {
                        ...
                        int reactTag2 = node.getChildAt(i11).getReactTag();
                        int i12 = i7 + i10;
                        iArr[i12] = i11;
                        iArr2[i12] = reactTag2;
                        iArr3[i10] = reactTag2;

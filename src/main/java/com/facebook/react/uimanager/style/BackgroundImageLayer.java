...
public final class BackgroundImageLayer {
    ...
    public static final class Companion {
        ...
        private final Gradient parseGradient(ReadableMap gradientMap, Context context) {
            if (gradientMap.hasKey(SVGParser.XML_STYLESHEET_ATTR_TYPE) && gradientMap.getType(SVGParser.XML_STYLESHEET_ATTR_TYPE) == ReadableType.String) {
                String string = gradientMap.getString(SVGParser.XML_STYLESHEET_ATTR_TYPE);

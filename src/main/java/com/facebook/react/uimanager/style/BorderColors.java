...
public final class BorderColors {
    ...
    public static final /* synthetic */ BorderColors m514boximpl(Integer[] numArr) {
        return new BorderColors(numArr);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static Integer[] m515constructorimpl(Integer[] edgeColors) {
        Intrinsics.checkNotNullParameter(edgeColors, "edgeColors");
        return edgeColors;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m517equalsimpl(Integer[] numArr, Object obj) {
        return (obj instanceof BorderColors) && Intrinsics.areEqual(numArr, ((BorderColors) obj).m522unboximpl());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m518equalsimpl0(Integer[] numArr, Integer[] numArr2) {
        return Intrinsics.areEqual(numArr, numArr2);
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m519hashCodeimpl(Integer[] numArr) {
        return Arrays.hashCode(numArr);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m521toStringimpl(Integer[] numArr) {
        return "BorderColors(edgeColors=" + Arrays.toString(numArr) + ")";
    }

    public boolean equals(Object obj) {
        return m517equalsimpl(this.edgeColors, obj);
    }

    public int hashCode() {
        return m519hashCodeimpl(this.edgeColors);
    }

    public String toString() {
        return m521toStringimpl(this.edgeColors);
    }

    /* JADX INFO: renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ Integer[] m522unboximpl() {
    ...
    public static /* synthetic */ Integer[] m516constructorimpl$default(Integer[] numArr, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            numArr = new Integer[LogicalEdge.values().length];
        }
        return m515constructorimpl(numArr);
    }
    ...
    public static final ColorEdges m520resolveimpl(Integer[] numArr, int i, Context context) {

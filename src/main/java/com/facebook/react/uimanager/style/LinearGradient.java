                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (map2 != null) {
                        if (!map2.hasKey(ViewProps.COLOR) || map2.isNull(ViewProps.COLOR)) {
                            ...
                            numValueOf = ColorPropConverter.getColor(map2.getMap(ViewProps.COLOR), context);
                        } else {
                            numValueOf = Integer.valueOf(map2.getInt(ViewProps.COLOR));
                        }
                        arrayList.add(new ColorStop(numValueOf, LengthPercentage.INSTANCE.setFromDynamic(map2.getDynamic(ViewProps.POSITION))));
                    }
                }
            } else {
                arrayList = null;

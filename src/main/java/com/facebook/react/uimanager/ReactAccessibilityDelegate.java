...
public class ReactAccessibilityDelegate extends ExploreByTouchHelper {
    ...
    static {
        ...
        map.put(StackTraceHelper.COLLAPSE_KEY, Integer.valueOf(AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_COLLAPSE.getId()));
    }
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (childAt != null) {
                    ...
                    try {
                        ...
                        if (accessibilityNodeInfoCompatObtain.isVisibleToUser()) {
                            if (!isAccessibilityFocusable(accessibilityNodeInfoCompatObtain, childAt)) {
                                if (isSpeakingNode(accessibilityNodeInfoCompatObtain, childAt)) {
                            ...
                            } else if (accessibilityNodeInfoCompatObtain != null) {
                                accessibilityNodeInfoCompatObtain.recycle();
                            }
                        } else if (accessibilityNodeInfoCompatObtain != null) {
                            accessibilityNodeInfoCompatObtain.recycle();

...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength65Plus(byte[] bArr, int i, int i2) {
        ...
        long jLoad65 = 95310865018149119L + LittleEndianByteArray.load64(bArr, i);
        long j = jShiftMix;
        int i8 = i;
        while (true) {
            char c2 = c;
            long jRotateRight = Long.rotateRight(jLoad65 + jLoad64 + jArr[0] + LittleEndianByteArray.load64(bArr, i8 + 8), 37) * K1;
            long jRotateRight2 = Long.rotateRight(jLoad64 + jArr[c2] + LittleEndianByteArray.load64(bArr, i8 + 48), 42) * K1;
            long j2 = jRotateRight ^ jArr2[c2];
            jLoad64 = jRotateRight2 + jArr[0] + LittleEndianByteArray.load64(bArr, i8 + 40);
            long jRotateRight3 = Long.rotateRight(j + jArr2[0], 33) * K1;
            weakHashLength32WithSeeds(bArr, i8, jArr[c2] * K1, j2 + jArr2[0], jArr);
            int i9 = i8;
            long[] jArr3 = jArr;
            weakHashLength32WithSeeds(bArr, i9 + 32, jRotateRight3 + jArr2[c2], LittleEndianByteArray.load64(bArr, i9 + 16) + jLoad64, jArr2);
            i8 = i9 + 64;
            if (i8 == i4) {
                ...
                jArr3[0] = j5;
                jArr2[0] = jArr2[0] + j5;
                long jRotateRight4 = Long.rotateRight(jRotateRight3 + jLoad64 + jArr3[0] + LittleEndianByteArray.load64(bArr, i6 - 55), 37) * j3;
                long jRotateRight5 = Long.rotateRight(jLoad64 + jArr3[c2] + LittleEndianByteArray.load64(bArr, i6 - 15), 42) * j3;
                ...
                weakHashLength32WithSeeds(bArr, i7, jArr3[c2] * j3, jArr2[0] + j6, jArr3);
                weakHashLength32WithSeeds(bArr, i6 - 31, jRotateRight6 + jArr2[c2], LittleEndianByteArray.load64(bArr, i6 - 47) + jLoad66, jArr2);
                return hashLength16(hashLength16(jArr3[0], jArr2[0], j3) + (shiftMix(jLoad66) * K0) + j6, hashLength16(jArr3[c2], jArr2[c2], j3) + jRotateRight6, j3);
            }
            c = c2;
            j = j2;
            jLoad65 = jRotateRight3;
            jArr = jArr3;
        }
    }
}

...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    CharMatcher precomputedInternal() {
        ...
        return new NegatedFastMatcher(precomputedPositive(i, bitSet, string.endsWith(".negate()") ? string.substring(0, string.length() - ".negate()".length()) : string + ".negate()")) { // from class: com.google.common.base.CharMatcher.1

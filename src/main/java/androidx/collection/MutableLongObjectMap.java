...
public final class MutableLongObjectMap<V> extends LongObjectMap<V> {
    ...
    private final void adjustStorage() {
        if (this._capacity > 8 && Long.compare(ULong.m948constructorimpl(ULong.m948constructorimpl(this._size) * 32) ^ Long.MIN_VALUE, ULong.m948constructorimpl(ULong.m948constructorimpl(this._capacity) * 25) ^ Long.MIN_VALUE) <= 0) {
